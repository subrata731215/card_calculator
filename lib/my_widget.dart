              ...
              return Row(
                ...
                children: [
                  Text(controller.p1TotalScore().toString(),
                          style: totalScoreTextStyle(controller)
                  ),
...
TextStyle totalScoreTextStyle(CallBridgeController controller) =>
     TextStyle(
...
class PlayerWiseCallCountWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: text.isNegative
          ? const EdgeInsets.only(left: 0, top: 6, bottom: 6)
